          ...
          {advServices.map((service, index) => {
            ...
            return (
              <div
                ...
                className={`relative flex flex-col rounded-2xl lg:rounded-3xl shadow-md lg:shadow-xl bg-white overflow-hidden cursor-pointer transition-all duration-500 ${spanClasses} ${
                  isOpen
                    ? "max-h-[1000px]"
              ...
              >
                ...
                >
                  ...
                  {/* Default view */}
                  {!isOpen && (
                    <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent flex items-end">
                ...
                {/* Expanded Content */}
                <div
                  className={`relative z-10 flex-1 flex flex-col bg-white shadow-inner overflow-y-auto transition-all duration-700 scrollbar-hide ${
                    isOpen
