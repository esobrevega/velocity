...
export default function MeetTheTeamPage() {
  ...
  const zIndexes = [10, 20, 30, 40, 30, 20, 10];

  return (
    <section className="rounded-b-4xl space-y-12 min-h-screen bg-white overflow-hidden">
      {/* About Us Section */}
      ...
      <div className="mb-10">
        <div className="max-w-3xl mx-auto text-center px-6 py-16 space-y-10">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            We are a passionate team dedicated to delivering outstanding services and
            solutions. Our mission is to empower individuals and businesses to achieve
            their goals with innovation, creativity, and integrity.
          </p>
          ...
          <div className="space-y-3">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              We are here to ensure that all of your financial decisions are made carefully
              ...
              return (
                <div
                  ...
                  className={`relative rounded-2xl p-4 flex flex-col items-center text-center
                              ...
                              sm:hover:scale-110 sm:hover:shadow-2xl
                              ${isDefaultHovered ? "sm:scale-110 sm:shadow-2xl" : ""}
                              ${orderClasses[i]}`}
                  style={{
                    zIndex: hoveredIndex === i ? 40 : zIndexes[i],
                  }}
